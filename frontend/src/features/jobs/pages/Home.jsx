...
import { fadeUp, staggerFadeUp, scrollFadeUp, scaleIn, textReveal, cleanupAnimations } from '../../../utils/animations.js'
        ...
        <div className='min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300'>
            ...
            <div className='bg-green-50 dark:bg-gray-800 py-20 px-6 text-center relative overflow-hidden'>
                ...
                <div className='relative z-10'>
                    ...
                    >
                        <span className='text-sm text-green-700 dark:text-gray-400'>Popular:</span>
                        {['React Developer', 'Accountant', 'NGO Jobs', 'Fresh Graduate', 'Remote'].map((tag, i) => (
                            <motion.span
                                key={i}
            ...
            >
                {[
                    ...
                    >
                        <div className={`text-2xl font-semibold ${stat.color}`}>{stat.num}</div>
            ...
            <div ref={categoriesRef} className='py-12 px-6 max-w-5xl mx-auto'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4'>
                    {[
                        { name: 'IT / Tech', count: '142', color: 'bg-green-50 dark:bg-green-900' },
                        { name: 'Finance', count: '89', color: 'bg-blue-50 dark:bg-blue-900' },
                        { name: 'NGO/INGO', count: '67', color: 'bg-amber-50 dark:bg-amber-900' },
                        { name: 'Marketing', count: '54', color: 'bg-purple-50 dark:bg-purple-900' },
                        { name: 'Healthcare', count: '41', color: 'bg-pink-50 dark:bg-pink-900' },
                        { name: 'Education', count: '38', color: 'bg-red-50 dark:bg-red-900' },
                    ].map((cat, i) => (
                        <motion.div
                            key={i}
                            className='cat-item'
