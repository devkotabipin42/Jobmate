...
const AdminPanel = () => {
  ...
  const handleVerifyEmployer = async (id) => {
    ...
    setEmployers((prev) =>
      prev.map((e) => (e._id === id ? { ...e, is_verified: true } : e)),
    );
  };
  const handleBanUser = async (id) => {
    await banUser(id);
    setUsers((prev) =>
      prev.map((u) => (u._id === id ? { ...u, is_banned: true } : u)),
    );
  };
  const handleUnbanUser = async (id) => {
    await unbanUser(id);
    setUsers((prev) =>
      prev.map((u) => (u._id === id ? { ...u, is_banned: false } : u)),
    );
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors">
      ...
      <div className="flex">
        {/* Sidebar — Desktop */}
        <div
          className={`hidden md:flex fixed left-0 top-16 h-[calc(100vh-64px)] w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-40 flex-col transition-all duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-64"}`}
        >
          {/* Admin Info */}
          <div className="p-4 border-b border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-900 flex items-center justify-center text-purple-700 dark:text-purple-300 font-bold text-lg">
                A
              </div>
              <div>
          ...
          <div className="p-4 border-t border-gray-100 dark:border-gray-700">
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div
                  key={i}
                  className="text-center bg-gray-50 dark:bg-gray-700 rounded-xl py-2"
                >
        ...
        {/* Main Content */}
        <div
          className={`flex-1 transition-all duration-300 ${sidebarOpen ? "md:ml-64" : "md:ml-0"} mb-16 md:mb-0`}
        >
          {/* Top Bar */}
              ...
              >
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        <div
                          className={`w-10 h-10 ${stat.bg} rounded-xl flex items-center justify-center text-white text-lg shadow-sm`}
                        />
                        <span className="text-xs text-green-600 font-medium bg-green-50 dark:bg-green-900 px-2 py-1 rounded-full">
                          {stat.change}
                        </span>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl p-6 text-white">
                    ...
                    <p className="text-xs text-purple-200 mt-2">
                      Avg{" "}
                      {Math.round(
                        stats.totalApplications / (stats.totalJobs || 1),
                      )}{" "}
                      per job
                    </p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="flex gap-3 flex-wrap">
                    {[
                      {
                        label: `Review Pending (${stats.pendingJobs})`,
                        tab: "pending",
                    ...
                    {pendingJobs.map((job, i) => (
                      ...
                      >
                        <div className="flex items-start justify-between gap-3 mb-3">
                          ...
                          <span className="text-xs bg-amber-50 text-amber-600 px-3 py-1 rounded-full font-medium shrink-0">
                            Pending
                          </span>
                        </div>
                    ...
                    {allJobs.map((job, i) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <span
                            className={`text-xs px-2 py-1 rounded-full font-medium ${job.is_verified ? "bg-green-50 text-green-600" : "bg-amber-50 text-amber-600"}`}
                          >
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2 text-xs">
                    <span className="bg-green-50 text-green-600 px-3 py-1.5 rounded-full font-medium">
                      {employers.filter((e) => e.is_verified).length} Verified
                    </span>
                    <span className="bg-amber-50 text-amber-600 px-3 py-1.5 rounded-full font-medium">
                    ...
                    {employers.map((employer, i) => (
                      ...
                      >
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex items-start gap-3">
                            <div
                              className={`w-12 h-12 rounded-xl flex items-center justify-center font-bold text-lg shrink-0 ${employer.is_verified ? "bg-green-50 text-green-700" : "bg-amber-50 text-amber-700"}`}
                            >
                            ...
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span
                                  className={`text-xs px-2 py-0.5 rounded-full font-medium ${employer.is_verified ? "bg-green-50 text-green-600" : "bg-amber-50 text-amber-600"}`}
                                >
            ...
            {activeTab === "users" && (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2 text-xs">
                    <span className="bg-green-50 text-green-600 px-3 py-1.5 rounded-full">
                      {users.length} Total
                    </span>
                ...
                {loading ? (
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                    {users.map((user, i) => (
                      <div
                        key={user._id}
                        className={`flex items-center justify-between gap-3 p-4 border-b border-gray-50 dark:border-gray-700 last:border-0 ${user.is_banned ? "bg-red-50 dark:bg-red-900/20" : "hover:bg-gray-50 dark:hover:bg-gray-700"}`}
                      >
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold text-sm shrink-0 ${user.is_banned ? "bg-red-100 text-red-600" : "bg-purple-50 text-purple-700"}`}
                          >
                            {user.name?.charAt(0)}
                          </div>
                          <div>
                  ...
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                        ...
                        <ResponsiveContainer width="100%" height={220}>
                          <BarChart
                            data={analytics.jobsByCategory.map((j) => ({
                              name: j._id,
                              value: j.count,
                            }))}
                          >
                      ...
                      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="flex items-center gap-4">
                          <ResponsiveContainer width="55%" height={180}>
                            <PieChart>
                              <Pie
                                data={analytics.jobsByType.map((j) => ({
                                  name: j._id,
                                  value: j.count,
                                }))}
                                cx="50%"
                          ...
                          <div className="space-y-2">
                            {analytics.jobsByType.map((item, i) => (
                              <div key={i} className="flex items-center gap-2">
                                ...
                                <span className="text-xs font-bold text-gray-800 dark:text-white ml-auto">
                                  {item.count}
                                </span>
                              </div>
                            ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                        ...
                        <ResponsiveContainer width="100%" height={200}>
                          <BarChart
                            data={analytics.applicationsByStatus.map((a) => ({
                              name: a._id,
                              value: a.count,
                            }))}
                          >
                            ...
                            <div key={i}>
                              ...
                              <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2">
                                <motion.div
                                  initial={{ width: 0 }}
                                  animate={{
                                    width: `${(loc.count / analytics.jobsByLocation[0].count) * 100}%`,
                                  }}
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
                      ...
                      <ResponsiveContainer width="100%" height={200}>
                        <LineChart
                          data={analytics.usersByMonth.map((u) => ({
                    ...
                    {reports.map((report, i) => (
                      ...
                      >
                        <div className="flex items-start justify-between gap-3 mb-3">
                          ...
                          <span
                            className={`text-xs px-3 py-1 rounded-full font-medium shrink-0 ${report.status === "pending" ? "bg-red-50 text-red-600" : report.status === "resolved" ? "bg-green-50 text-green-600" : "bg-gray-100 text-gray-500"}`}
                          >
                            {report.status}
                          </span>
                        </div>
                    ...
                    {testimonials.map((t, i) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full ${t.status === "approved" ? "bg-green-50 text-green-600" : t.status === "rejected" ? "bg-red-50 text-red-600" : "bg-yellow-50 text-yellow-600"}`}
                          >
                            {t.status}
                          </span>
                        </div>
                        ...
                        <div className="flex gap-2 mt-4">
                          {t.status !== "approved" && (
                            <button
                              ...
                              className="text-xs bg-green-600 text-white px-4 py-2 rounded-xl hover:bg-green-700 transition-colors"
                            >
                              Approve
                            </button>
                          )}
                          {t.status !== "rejected" && (
                            <button
                              ...
                              className="text-xs border border-red-200 text-red-500 px-4 py-2 rounded-xl hover:bg-red-50 transition-colors"
                            >
                              Reject
                            </button>
                          )}
                          <button
                            ...
                            className="text-xs border border-gray-200 text-gray-500 px-4 py-2 rounded-xl hover:bg-gray-50 transition-colors"
                          >
                            Delete
                          </button>
                        </div>
                      ...
                      {selectedTicket.replies?.length > 0 && (
                        <div className="space-y-2 mb-4">
                          {selectedTicket.replies.map((reply, i) => (
                            <div
                              key={i}
                              className={`rounded-xl p-3 ${reply.isAdmin ? "bg-purple-50 dark:bg-purple-900" : "bg-gray-50 dark:bg-gray-700"}`}
                            >
        ...
        <div className="flex items-center justify-around px-2 py-2 overflow-x-auto">
          {sidebarItems.slice(0, 5).map((item) => (
            ...
            >
              ...
              {item.count > 0 && (
                <span className="absolute -top-0.5 right-0 w-4 h-4 bg-purple-600 text-white text-xs rounded-full flex items-center justify-center">
                  {item.count}
                </span>
              )}
            </button>
