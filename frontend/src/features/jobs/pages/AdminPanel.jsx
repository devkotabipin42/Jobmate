            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-green-500 to-green-700 rounded-2xl p-6 text-white">
                ...
                <p className="text-xs text-green-200 mt-2">
                  {Math.round((stats.verifiedJobs / stats.totalJobs) * 100) ||
                    0}
                  % of total jobs
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-6 text-white">
                ...
                <p className="text-xs text-blue-200 mt-2">Active on platform</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl p-6 text-white">
                ...
                <p className="text-xs text-purple-200 mt-2">
                  Avg{" "}
                  {Math.round(stats.totalApplications / (stats.totalJobs || 1))}{" "}
                  per job
                </p>
              </div>
            </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      {!employer.is_verified && (
                        <div className="flex flex-col gap-2 shrink-0">
                          ...
                          <button className="text-xs border border-red-200 dark:border-red-700 text-red-500 dark:text-red-300 px-5 py-2 rounded-xl hover:bg-red-50 dark:hover:bg-red-900 transition-colors">
                            ✕ Reject
                          </button>
                        </div>
                      )}
        ...
        >
          ...
          {loading ? (
            ...
            <div className="text-center py-20 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Users have not reported any jobs
              </p>
            </div>
          ) : (
            <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <button
                      ...
                      className="text-xs border border-gray-200 dark:border-gray-600 text-gray-500 px-4 py-2 rounded-xl hover:bg-gray-50 transition-colors"
                    >
                      Delete
                    </button>
                  </div>
