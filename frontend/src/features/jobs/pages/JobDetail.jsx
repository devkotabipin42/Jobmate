                ...
                >
                    ...
                    <div className='flex items-start justify-between gap-4 mb-6'>
                        <div className='flex items-start gap-4'>
                            <div className='w-14 h-14 rounded-xl bg-green-50 dark:bg-green-900 flex items-center justify-center text-green-700 dark:text-green-300 font-bold text-xl'>
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-xl'>
                        {[
                            ...
                            <div key={i}>
                                ...
                                <p className='text-sm font-medium text-gray-800 dark:text-white capitalize'>{item.value}</p>
                            </div>
                        ))}
                    </div>
                                ...
                                <div>
                                    ...
                                    <p className='text-xs text-gray-500 dark:text-gray-400'>
                                        ...
                                        {job.employer.website && (
                                            <> · <a href={job.employer.website} target='_blank' rel='noreferrer' className='text-green-600 hover:underline'>
                                                Visit website
                                            </a></>
                                        )}
                                    </p>
