        ...
        <div className='min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors'>
            ...
            <div className='flex'>
                ...
                <motion.div
                    ...
                    className='fixed left-0 top-16 h-[calc(100vh-64px)] w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-40 flex flex-col'
                >
                    {/* Company Info */}
                            ...
                            >
                                ...
                                <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                                    {[
                                        ...
                                        { label: 'Total Applications', value: totalApplications, color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-900' },
                                            ...
                                            applications.map((app, i) => (
                                                ...
                                                >
                                                    <div className='flex items-start justify-between gap-3 mb-3'>
                                                        <div className='flex items-center gap-3'>
                                                            <div className='w-10 h-10 rounded-full bg-green-50 dark:bg-green-900 flex items-center justify-center text-green-700 dark:text-green-300 font-semibold'>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className='text-xs text-gray-500 dark:text-gray-400'>
                                                                    {app.user?.email} · {app.user?.location || 'No location'}
                                                                </p>
                                                            </div>
                                                        </div>
